...
if(isset($_POST["user"], $_POST["name"], $_POST["desc"], $_POST["ingrs"], $_POST["apps"], $_POST["instr"], $_POST["cat"], $_POST["time"], $_POST["serv"], $_POST["priv"], $_POST["diff"]))
    {
      ...
      $query = "INSERT INTO `recipe` (`user_ID`, `recipe_ID`, `recipe_Name`, `recipe_Description`, `category`, `time`, `private_recipe`, `servings`, `difficulty`, `picture`, `times_cooked`, `ingredients`, `appliances`) VALUES ('$user_ID', NULL, '$name', '$desc', '$category', '$time', '$private', '$servings', '$difficulty', 'N/A', '$times_cooked', '$ingrs', '$apps')";
	    $result = mysqli_query($con, $query);
      echo $result[ "recipe_ID" ];
	}
